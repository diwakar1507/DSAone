...
function ViewCard(props) {
  ...
  return (
    <div className={`inline-block ${scheme ? 'bg-plain-white' : 'bg-primary-3'} rounded-lg h-64 w-64 shadow-lg transform transition duration-500 hover:scale-110 hover:shadow-xl`}>
