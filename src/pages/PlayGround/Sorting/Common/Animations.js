...
export const swapAnimation = (distance, swapColor) => keyframes`
  ...
  70% {
    transform: translate(-${distance * 54 + (distance > 1 ? 4 : 0)}px, -50px);
    background-color: ${swapColor};
  }
  99% {
    transform: translate(-${distance * 54 + (distance > 1 ? 4 : 0)}px, 0px);
    background-color: ${swapColor};
  }
  100%{
    transform: translate(-${distance * 54 + (distance > 1 ? 4 : 0)}px, 0px);
...
export const destinationAnimation = (distance, swapColor) => keyframes`
  ...
  80% {
    ...
    transform: translate(-${distance * 50 + 4}px, 50px);
    background-color: ${swapColor};
  }
  99% {
    
    transform: translate(-${distance * 50 + 4}px, 0px);
    background-color: ${swapColor};
  }
  100%{
