const FW = () => {
  return (
    <div className="text-xl py-10 px-14 bg-primary-1 text-white">
      ...
      works for both the directed and undirected weighted graphs. But, it does
      not work for the graphs with negative cycles (where the sum of the edges
      ...
      <br />
      graph Initial graph Follow the steps below to find the shortest path
      between all the pairs of vertices.
      <br />
      <li>
        Create a matrix A0 of dimension n*n where n is the number of vertices.
        The row and the column are indexed as i and j respectively. i and j are
      ...
      left as infinity. matrix floyd warshall algorithm Fill each cell with the
      distance between ith and jth vertex
      <li>
      ...
      A[i][k] + A[k][j].
      <br />
      In this step, k is vertex 1. We calculate the distance from source vertex
      to destination vertex through this vertex k. matrix floyd warshall
      algorithm Calculate the distance from the source vertex to destination
      vertex through this vertex k
      <br />
      For example: For A1[2, 4], the direct distance from vertex 2 to 4 is 4 and
      the sum of the distance from vertex 2 to 4 through vertex (ie. from vertex
      2 to 1 and from vertex 1 to 4) is 7. Since 4 {"<"} 7, A0[2, 4] is filled
      with 4.
      <li>
        Similarly, A2 is created using A1. The elements in the second column and
      ...
      <br /> Calculate the distance from the source vertex to destination vertex
      through this vertex 2<li>Similarly, A3 and A4 is also created.</li>
      <br /> matrix floyd warshall algorithm
      <br />
      Calculate the distance from the source vertex to destination vertex
      through this vertex 3
      <br />
      <br /> matrix floyd warshall algorithm
      <br />
      Calculate the distance from the source vertex to destination vertex
      through this vertex 4
      ...
      <br />
      <div className="text-2xl py-5 text-yellow-100">Space Complexity</div>
      <br />
