const Merge = () => {
    return (
        <div className="text-xl py-10 px-14 bg-primary-1 text-white">
            ...
            <li></li>  Divide the unsorted list into n sublists, each comprising 1 element (a list of 1 element is supposed sorted).
            ...
            <div className="text-2xl py-5 text-yellow-100">Implementation</div>
        </div>
    );
}
