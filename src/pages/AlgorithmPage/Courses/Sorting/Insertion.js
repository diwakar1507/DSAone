...
const Insertion = () => {
  return (
    <div className="text-xl py-10 px-14 bg-primary-1 text-white">
      ...
      <br />
      Now hold on to the third element (31) and compare with the ones preceding
      it . Since 31{">"} 25, no swapping takes place. Also, 31{">"}17, no
      ...
      <br />
      But there still exist elements that we haven’t yet compared with 13. Now
      the comparison takes place between 25 and 13. Since, 13 {"<"} 25, we swap
      the two.
      <br />
      ...
      13, 17, 2, 25, 31.
      <br />
      Compare 2 with 17 and 13.Since, 2{"<"}17. Swap 2 and 17.
      <br />
      Array now becomes: 13, 2, 17, 25, 31.
      <br />
      The last comparison for the Iteration is to compare 2 with 13 . Since 2
      {"<"} 13. Swap 2 and 13.
      <br />
      ...
      sorted array to the insertion sort algorithm, it will still execute the
      outer for loop, thereby requiring n steps to sort an already sorted array
      of n elements, which makes its best case time complexity a linear function
      of n.
      <br />
      <br />
      Wherein for an unsorted array, it takes for an element to compare with all
      the other elements which mean every n element compared with all other n
      elements. Thus, making it for n x n, i.e., n2 comparisons. One can also
      take a look at other sorting algorithms such as Merge sort, Quick Sort,
      Selection Sort, etc. and understand their complexities.
      <strong>Worst Case Time Complexity [ Big-O ]: O(n2)</strong>
      <br />
