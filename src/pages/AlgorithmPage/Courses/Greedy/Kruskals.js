...
const Kruskals = () => {
    return (
        <div className="text-xl py-10 px-14 bg-primary-1 text-white">
            ...
            <div className="text-8xl text-center text-yellow-200 py-8">Kruskals Algorithm</div>
            ...
            <div className="text-2xl py-5 text-yellow-100">How Kruskals's algorithm works</div>
            ...
            <div className="pl-5 py-2">
                ...
                <li>Keep adding edges until we reach all vertices.</li></div>
            <div className="text-2xl py-5 text-yellow-100">Kruskal's Algorithm Complexity</div>
            The time complexity of Kruskal's algorithm is O(E log E).

            <div className="text-2xl py-5 text-yellow-100">Kruskal's Algorithm Application</div>
