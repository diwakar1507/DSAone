...
const Job = () => {
    return (
        <div className="text-xl py-10 px-14 bg-primary-1 text-white">
            <div className="text-8xl text-center text-yellow-200 py-8">Job Sequencing Problem</div>
            ...
            <br />From this set of jobs, first we select J2, as it can be completed within its deadline and contributes maximum profit.
            <div className="pl-6 py-5">
                <li>Next, J1 is selected as it gives more profit compared to J4.</li>

                <li> In the next clock, J4 cannot be selected as its deadline is over, hence J3 is selected as it executes within its deadline.</li>

                <li> The job J5 is discarded as it cannot be executed within its deadline.</li>
            </div>
