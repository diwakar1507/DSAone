...
const PathfindingVisualizer = (props) => {
  ...
  const [animationDelay, setAnimationDelay] = useState(ANIMATION_FAST) // Animation delay between css visualization animations
    ...
    <div className="bg-primary-1">
      ...
      <div className=" bg-primary-1">
        ...
        <div className=" text-xl text-white mb-4 py-5 backdrop-filter shadow-bar backdrop-blur-md backdrop-brightness-125 shadow-2xl">
          ...
          <div className=" px-10">
            <button
              className=" hover:border-b-2 hover: border-b-primary-3 hover:text-yellow-100  p-1 mx-5 "
              onClick={() => {
                clearNodeClasses();
            ...
            <button
              className="hover:border-b-2 p-1 mx-5 hover:text-yellow-100  hover: border-b-primary-3"
              onClick={() => {
                clearNodeClasses();
                setAlgorithm(ASTAR);
            ...
            <button
              className="hover:border-b-2 mx-5 p-1 hover:text-yellow-100  hover: border-b-primary-3"
              onClick={() => {
                clearNodeClasses();
                setAlgorithm(DFS);
            ...
            <button
              className=" bg-primary-3 px-3 rounded-xl ml-10 hover:bg-orange-600 text-xl p-1 mx-10 border-b-2"
              onClick={() => {
                if (algorithm !== "") {
                  visualize(algorithm);
                } else {
            ...
            <button
              className="{speedBtnClass} bg-primary-3 px-3 rounded-xl ml-10 hover:bg-orange-600 text-xl p-1 mx-10 border-b-2"
              onClick={() => cycleSpeed()}
              disabled={isButtonDisabled}
            >
              Speed: {animationDelay} ms
            </button>
