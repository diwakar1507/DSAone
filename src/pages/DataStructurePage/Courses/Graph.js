        ...
        <>
            <div className="bg-primary-1 overflow-hidden pb-24">
                ...
                <div className="bg-slate-800 pb-24 px-28" >
                    <div className="text-5xl py-16 font-serif text-yellow-200" ><h1>Introduction To Graph</h1></div>
                    ...
                    <div className="text-5xl py-16 font-serif text-yellow-200" ><h1>Glossary</h1></div>
                    <div className="text-2xl text-slate-300">
                   ...
                   <br/><br/>
                    ...
                    <br/><br/>
                    <strong className="text-yellow-100 text-3xl">Directed edge:</strong><br/><br/>
                    ...
                    <br/><br/>
                    <strong className="text-yellow-100 text-3xl">Undirected edge:</strong><br/><br/>
                    <li>unordered pair of vertices (u, v)</li> 
                    <li>Example: railway lines</li>  
                    <br/><br/>
                    <strong className="text-yellow-100 text-3xl">Directed graph:</strong><br/><br/>
                    <li>all the edges are directed</li> 
                    <li>Example: route network</li> 
                    <br/><br/>
                    <strong className="text-yellow-100 text-3xl">Undirected graph:</strong><br/><br/>
                    <li>all the edges are undirected</li>  
                    <li> Example: flight network</li>
                    <li>When an edge connects two vertices, the vertices are said to be adjacent to each
                    other and the edge is incident on both vertices.</li> 
                    <li>A graph with no cycles is called a tree. A tree is an acyclic connected graph.</li> 
                    ...
                    <li> A subgraph is a subset of a graph’s edges (with associated vertices) that form a
                    graph.</li>
                    <li> A path in a graph is a sequence of adjacent vertices. Simple path is a path with no
                    repeated vertices. In the graph below, the dotted lines represent a path from G to E.</li> 
                    <li>A cycle is a path where the first and last vertices are the same. A simple cycle is a
                    cycle with no repeated vertices or edges (except the first and last vertices).</li> 
                    <li> We say that one vertex is connected to another if there is a path that contains both of
                    them.</li> 
                    <li>A graph is connected if there is a path from every vertex to every other vertex.</li>  
                    <li>If a graph is not connected then it consists of a set of connected components.</li>  
                    <li>A directed acyclic graph [DAG] is a directed graph with no cycles.</li>  
                    <li>A forest is a disjoint set of trees.</li>  
                    <li>A spanning tree of a connected graph is a subgraph that contains all of that graph’s
                    vertices and is a single tree. A spanning forest of a graph is the union of spanning
                    trees of its connected components.</li> 
                    <li>A bipartite graph is a graph whose vertices can be divided into two sets such that all
                    edges connect a vertex in one set with a vertex in the other set.</li> 
                    <li> In weighted graphs integers (weights) are assigned to each edge to represent
                    (distances or costs).</li>
                    <li>Graphs with all edges present are called complete graphs.</li> 
                    <li>Graphs with relatively few edges (generally if it edges {'<'}  {'|'}V{'|'} log {'|'}V{'|'} ) are called
                    sparse graphs.</li> 
                    <li>Graphs with relatively few of the possible edges missing are called dense.</li> 
                    <li>Directed weighted graphs are sometimes called network.</li> 
                    <li>We will denote the number of vertices in a given graph by |V|, and the number of
                    edges by |E|. Note that E can range anywhere from 0 to |V|(|V| – l)/2 (in undirected
                    graph). This is because each node can connect to every other node.</li> 

                    </div>

                    <div className="text-5xl py-16 font-serif text-yellow-200" ><h1>Applications of Graph</h1></div>
                    
                    <div className="text-2xl text-slate-300">
                    <li>Representing relationships between components in electronic circuits</li> 
                    <li>Transportation networks: Highway network, Flight network</li> 
                    <li>Computer networks: Local area network, Internet, Web</li> 
                    </div>
                    <div className="text-5xl py-16 font-serif text-yellow-200" ><h1>Graph Representation</h1></div>
                    <div className="text-2xl text-slate-300">
                    <li>Representing relationships between components in electronic circuits</li> 
                    <li> As in other ADTs, to manipulate graphs we need to represent them in some useful form. Basically,
                    ...
                    <strong className="text-yellow-100 text-3xl">Adjacency Matrix</strong>
                    <br/><br/>
                    ...
                    bits of storage and O(V2
                    ) time for initialization. If the number of edges is proportional to V2
                    , then
                    ...
                    <br/><br/>
                    It is very much similar to adjacency list but instead of using Linked lists, Disjoint Sets [UnionFind] are used. For more details refer to the Disjoint Sets ADT chapter.
