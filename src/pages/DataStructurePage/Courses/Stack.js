      ...
      <div className="bg-primary-1 overflow-hidden pb-24">
        ...
        <div className="flex">
          <div className="px-10 py-10 w-1/2 h-1/2" ref={StackRef}>
            <div className="text-5xl w-3/4 text-white font-serif font-bold h-fit">
              Let's learn about Stack it will be fun........
            </div>
          </div>
          <div
            className="h-72 w-24 border-r-2 border-b-2 border-slate-900 rounded-b-2xl  border-l-2 px-1 bg-zinc-900 mx-7"
            ref={hsquare1}>
            <div
              className="w-96px h-7 bg-green-800 rounded border-2 border-lime-700 mt-28"
              ref={el1}></div>
            <div
              className="w-96px h-7 bg-green-800 rounded border-2 border-lime-700 my-1"
              ref={el2}></div>
            <div
              className="w-96px h-7 bg-green-800 rounded border-2 border-lime-700 my-1"
              ref={el3}></div>
        ...
        <div ref={intro}>
          ...
          <div className="text-2xl px-28 text-slate-300">
            ...
            etc.Stack Example - A real-world stack allows operations at one end
            only. For example, we can place or remove a card or plate from the
            top of the stack only. Likewise, Stack ADT allows all data
            operations at one end only. At any given time, we can only access
            the top element of a stack. Stack is a linear data structure that
            ...
            <div className="py-7  pr-28 text-white text-2xl " ref={operation}>
              <div className="flex" ref={image}>
                <img className=" h-96 mt-10  " src={stack1} alt="Stack" />
                <img
          ...
          <div className="text-2xl px-32 pb-16 text-center text-slate-300">
            push(), pop(), isEmpty() and peek() all take O(1) time. We do not
            run any loop in any of these operations.
          </div>
          <div className="text-5xl text-center text-yellow-200 font-serif">
          ...
          <div className="text-2xl pt-9 px-28 text-slate-300">
            ...
            <li>
              ...
              another path. To get back from a current state we need to store
